...
const buttonSave = document.getElementById("saveInfo");
const buttonBack = document.getElementById("backButton");
const buttonRedo = document.getElementById("redoButton");

// var timeM = document.getElementById("minutesInput").value;
// let timeM = minutesInput;

// var timeM = document.getElementById("secondsInput").value;
// let timeS = secondsInput;

const form = document.getElementById("timer");
const inputTimer = document.getElementsByClassName("inpuTimer");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Como no botão lá não tem um onclick, ele é adicionado aquiusando o addEventListener
